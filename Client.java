    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (!option.equalsIgnoreCase("quit")) {
            ...
            if (option.equalsIgnoreCase("add")) {
                collectionManager.add(Hike.parse(console)); 
                System.out.println();

            } else if (option.equalsIgnoreCase("contains")) {
                System.out.println(collectionManager.contains(Hike.parse(console)));
                System.out.println();
                ...
                System.out.println
                ("Enter a number to check if a hike's length is what you are looking for!");
                double temp = Double.parseDouble(console.nextLine());
                System.out.println("Results: " + collectionManager.filter(temp));
                System.out.println();
